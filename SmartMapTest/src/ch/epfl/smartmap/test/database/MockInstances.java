...
public class MockInstances {
    ...
    public static final Invitation ROBIN_FRIEND_INVITATION = CREATOR
        .getInvitation(ROBIN_FRIEND_INVITATION_CONTAINER.getId());
    ...
    public static final Invitation POLYLAN_EVENT_INVITATION = CREATOR
        .getInvitation(POLYLAN_EVENT_INVITATION_CONTAINER.getId());
