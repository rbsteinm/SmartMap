...
public class MockContainers {
	...
	static {
		...
		POLYLAN_CONTAINER =
				new EventContainer(POLYLAN_ID, POLYLAN_NAME, JULIEN_CONTAINER, POLYLAN_DESCRIPTION, POLYLAN_START_DATE,
	...
	public static final long FAMILY_ID = 2;
	public static final String FAMILY_NAME = "Family";
	public static final Set<Long> FAMILY_IDS = Sets.newHashSet(ALAIN_CONTAINER.getId());
	...
	static {
		ROBIN_FRIEND_INVITATION_CONTAINER =
				new InvitationContainer(ROBIN_FRIEND_INVITATION_ID, ROBIN_CONTAINER, null, ROBIN_FRIEND_INVITATION_STATUS,
	...
	static {
		ROBIN_FRIEND_ACCEPTED_INVITATION_CONTAINER =
				new InvitationContainer(ROBIN_FRIEND_ACCEPTED_INVITATION_ID, ROBIN_CONTAINER, null,
						ROBIN_FRIEND_ACCEPTED_INVITATION_STATUS, ROBIN_FRIEND_ACCEPTED_INVITATION_TIMESTAMP,
						ROBIN_FRIEND_ACCEPTED_INVITATION_TYPE);
	}
	...
	static {
		POLYLAN_EVENT_INVITATION_CONTAINER =
				new InvitationContainer(POLYLAN_EVENT_INVITATION_ID, null, POLYLAN_CONTAINER,
						POLYLAN_EVENT_INVITATION_STATUS, POLYLAN_EVENT_INVITATION_TIMESTAMP, POLYLAN_EVENT_INVITATION_TYPE);
	}
}