...
public class CacheTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        JULIEN =
            new ImmutableUser(1, "Julien", "123456789", "julien@epfl.ch", LOCATION_ONE, "Grandvaux", User.NO_IMAGE,
                false);

        ALAIN =
            new ImmutableUser(2, "Alain", "123456789", "alain@epfl.ch", LOCATION_ONE, "Pully", User.NO_IMAGE, false);
