...
public class CacheTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        /*
         * EVENT_WITH_NO_ID =
         * new ImmutableEvent(Event.NO_ID, "This is an Event name", 5,
         * "This is a description", DATE_ONE, DATE_TWO,
         * LOCATION_ONE, "This is a location", new HashSet<Long>());
         * FOOTBALL_TOURNAMENT =
         * new ImmutableEvent(1, "Football Tournament", 2, "Foot is great",
         * DATE_ONE, DATE_TWO, LOCATION_ONE,
         * "Morges", new HashSet<Long>(1, 2));
         * POLYLAN =
         * new ImmutableEvent(2, "Polylan", 1, "Video games are better",
         * DATE_ONE, DATE_TWO, LOCATION_ONE, "EPFL",
         * new HashSet<Long>(1));
         * JULIEN =
         * new ImmutableUser(1, "Julien", "123456789", "julien@epfl.ch",
         * LOCATION_ONE, "Grandvaux", UserInterface.NO_IMAGE,
         * false);
         * ALAIN =
         * new ImmutableUser(2, "Alain", "123456789", "alain@epfl.ch",
