	...
	private List<String> friendJsonFields;
	  ...
	  @Test
	    ...
	    public void testParseFriendTooLongName() throws JSONException{
	    	JSONObject jsonObject=new JSONObject(FRIEND_JSON);
	    	jsonObject.put("name", "egrhgpiergbpwifbowiegforwgtoiedfbéwgfboéwagrfowéargforwgfowaugfowiegfowaifgoawéietgéwagprigfsgfgjkaegoirgorigéraoigpwrgoéwigaowigfvbrofgroivrhtoghroufgvborthgoéaiegéorifgoga");
	    	SmartMapParser parser = new JsonSmartMapParser();
