...
public class NetworkEndToEndTest extends AndroidTestCase {
	...
	public void testGetFriendInvitations() throws SmartMapClientException {
		...
		NetworkFriendInvitationBag invitationBag = (NetworkFriendInvitationBag) networkClient
	...
	public void testInviteUsersToEvent() throws SmartMapClientException {
		networkClient.inviteUsersToEvent(CREATED_EVENT_ID,
	...
	public void testUpdateEventName() throws SmartMapClientException {
		...
		EventContainer update = new EventContainer(CREATED_EVENT_ID, "Toto",
				Smartmap_Sweng, "Not a basketball tournament !",
		...
		EventContainer modifiedEvent = networkClient
				.getEventInfo(CREATED_EVENT_ID);
		assertEquals("Updated event name does not match",
				modifiedEvent.getName(), "Toto");
	...
	private void assertValidEventInvitation(InvitationContainer invitation) {
		...
		assertTrue("Unexpected invitation type",
				(invitation.getType() == Invitation.EVENT_INVITATION));
	...
	private void initContainers(){
		Smartmap_Sweng = new UserContainer(
				SMARTMAP_SWENG_ID, SMARTMAP_SWENG_NAME, null, null, null, null,
				null, User.NO_BLOCK_STATUS, User.FRIEND);
		footballTournament = new EventContainer(
				0, "Football Tournament", Smartmap_Sweng,
