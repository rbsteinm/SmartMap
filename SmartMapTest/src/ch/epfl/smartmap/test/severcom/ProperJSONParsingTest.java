...
public class ProperJSONParsingTest extends TestCase {
	...
	private void checkEvent1(Event event) {
		...
		assertEquals("latitude does not match", location1.getLatitude(),
				event.getLatLng().latitude);
		assertEquals("Friend's longitude does not match",
				location1.getLongitude(), event.getLatLng().longitude);
	...
	private void checkEvent2(Event event) {
		...
		assertEquals("latitude does not match", location2.getLatitude(),
				event.getLatLng().latitude);
		assertEquals("Friend's longitude does not match",
				location2.getLongitude(), event.getLatLng().longitude);
