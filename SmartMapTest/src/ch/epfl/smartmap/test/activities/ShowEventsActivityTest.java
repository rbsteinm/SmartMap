...
public class ShowEventsActivityTest extends ActivityInstrumentationTestCase2<ShowEventsActivity> {
    ...
    private void addMockEventsInDB() throws SmartMapClientException, InterruptedException {
        ...
        EventContainer eventContainer =
            new EventContainer(1, "Test event", userContainer, "test descr", now, inFiveMins, loc, "EPFL",
                new HashSet<Long>());
        ...
        PublicEvent e3 =
            new PublicEvent(4, "Far away", me, timeE3, timeEndE3, verbier, "Somewhere very far",
                "hello", participants);
