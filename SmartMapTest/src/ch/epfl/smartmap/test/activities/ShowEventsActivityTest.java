 ...
 * tests if the server interferes with them later.
 * 
 * @author SpicyCH
 */
...
ActivityInstrumentationTestCase2<ShowEventsActivity> {
	...
	public void testCanOpenAddEventActivity() {
		openActionBarOverflowOrOptionsMenu(this.getInstrumentation()
				.getTargetContext());
	...
	private void addMockEventsInDB() {
		...
		PublicEvent e2 = new PublicEvent("LOL Tournament", 1, "Alain", timeE2,
				timeEndE2, epfl);
		e2.setID(2);
