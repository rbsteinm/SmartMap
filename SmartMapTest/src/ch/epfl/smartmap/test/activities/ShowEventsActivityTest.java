...
public class ShowEventsActivityTest extends ActivityInstrumentationTestCase2<ShowEventsActivity> {
    ...
    private void addMockEventsInDB() throws SmartMapClientException, InterruptedException {
        ...
        PublicEvent e0 =
            new PublicEvent(1, "Lutry fun", me, timeE0, timeEndE0, lutry, "Lutry", "Le fun à lutry", participants);
        ...
        PublicEvent e1 =
            new PublicEvent(2, "Electrosanne", me, timeE1, timeEndE1, lausanne, "Lausanne", "boom boom", participants);
        ...
        PublicEvent e2 =
            new PublicEvent(3, "Espresso tesing", me, timeE2, timeEndE2, epfl, "EPFL", "have a cup of Espresso",
                participants);
        ...
        PublicEvent e3 =
            new PublicEvent(4, "Far away", me, timeE3, timeEndE3, verbier, "Somewhere very far", "hello", participants);
