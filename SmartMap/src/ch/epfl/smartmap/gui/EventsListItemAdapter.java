...
public class EventsListItemAdapter extends ArrayAdapter<Event> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		double distanceMeEvent = ShowEventsActivity.distance(mMyLocation.getLatitude(),
		    mMyLocation.getLongitude(), mItemsArrayList.get(position).getLocation().getLatitude(),
