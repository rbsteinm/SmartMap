...
public class MockDB {
    ...
    public static final ArrayList<Friend> FRIENDS_LIST = new ArrayList<Friend>(Arrays.asList(JULIEN, ALAIN,
            ROBIN, MATTHIEU, NICOLAS, MARION, RAPHAEL, HUGO, GUILLAUME, SELINE, CYRIL, PIETRO, CHRISTIE,
            MARIE));
    ...
    public static List<Event> getEventsList() {
        ...
        Event birthday = new UserEvent("Marion's birthday", MARION.getID(), MARION.getName(),
