...
public class MockDB {
    ...
    public static final Friend HUGO = new Friend(7, "Hugo Sbai", 47.5547877, 4.4255457);
    public static final List<Friend> FRIENDS_LIST = Arrays.asList(JULIEN, ALAIN, ROBIN, MATTHIEU, NICOLAS, MARION,
            RAPHAEL, HUGO);
    ...
    public static List<Event> getEventsList() {
        ...
        Event footballTournament = new UserEvent("Football Tournament", HUGO.getID(), HUGO.getName(),
                new GregorianCalendar(2014, 11, 23), new GregorianCalendar(2014, 11, 27), locationFootball);
        Event conference = new UserEvent("Conference on cellular networks", HUGO.getID(), HUGO.getName(),
                new GregorianCalendar(2014, 11, 26), new GregorianCalendar(2014, 11, 26), locationConference);
        Event birthday = new UserEvent("Marion's birthday", MARION.getID(), MARION.getName(), new GregorianCalendar(
                2014, 11, 20), new GregorianCalendar(2014, 11, 20), locationBirthday);
