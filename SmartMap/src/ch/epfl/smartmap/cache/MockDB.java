...
public class MockDB {
	...
	public static List<Event> getEventsList() {
		...
		Event footballTournament = new UserEvent("Football Tournament",
				HUGO.getID(), HUGO.getName(), new GregorianCalendar(2014, 11,
						23), new GregorianCalendar(2014, 11, 27),
				locationFootball);
		Event conference = new UserEvent("Conference on cellular networks",
				HUGO.getID(), HUGO.getName(), new GregorianCalendar(2014, 11,
						26), new GregorianCalendar(2014, 11, 26),
				locationConference);
		Event birthday = new UserEvent("Marion's birthday", MARION.getID(),
				MARION.getName(), new GregorianCalendar(2014, 11, 20),
