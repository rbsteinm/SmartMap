    ...
    private synchronized boolean updateUsers(Set<ImmutableUser> userInfos) {
        ...
        for (ImmutableUser userInfo : userInfos) {
            ...
            if (user != null) {
                ...
                if ((user.getFriendship() == userInfo.getFriendship()) || (user.getFriendship() == User.DONT_KNOW)
                    || (user.getFriendship() == User.NO_ID) || (user.getFriendship() == User.SELF)) {
                    ...
                    // type
                    Log.d(TAG, "Detected type change, id : " + user.getId() + ", type : " + user.getFriendship());
