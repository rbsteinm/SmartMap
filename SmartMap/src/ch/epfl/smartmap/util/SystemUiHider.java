...
public abstract class SystemUiHider {
     ...
     */
    public static final int FLAG_HIDE_NAVIGATION = 0x6;
    ...
    /**
     * @return private field mActivity
     */
    ...
    /**
     * @return private field mAnchorView
     */
    ...
    /**
     * @return private field mOnVisibilityChangeListener
     */
    ...
    public void setOnVisibilityChangeListener(OnVisibilityChangeListener listener) {
        OnVisibilityChangeListener newListener = null;
        if (listener == null) {
            newListener = sDummyListener;
        } else {
            newListener = listener;
        }

        mOnVisibilityChangeListener = newListener;
    }
