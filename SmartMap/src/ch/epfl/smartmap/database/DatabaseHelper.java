...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addAcceptedRequest(GenericInvitation invitation) {
        long id =
    ...
    public long addEventInvitation(GenericInvitation invitation) {
        long id =
            this.getFriendInvitations().size() + this.getEventInvitations().size() + this.getAcceptedRequests().size()
                + 1;
        // using getAllInvitations would cause unnecessary sorting
     ...
     */
    public long addFriendInvitation(GenericInvitation invitation) {
        long id =
            this.getFriendInvitations().size() + this.getEventInvitations().size() + this.getAcceptedRequests().size()
                + 1;
        // using getAllInvitations would cause unnecessary sorting
