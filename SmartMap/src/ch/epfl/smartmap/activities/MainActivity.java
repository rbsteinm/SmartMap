...
public class MainActivity extends FragmentActivity implements CacheListener, OnInvitationListUpdateListener {
    ...
    /**
     * Sets the main Menu of the Activity, which contains a search icon and the notification badge.
     */
    ...
    /**
     * Sets the Title, Subtitle and Image of the {@code ActionBar} with the informations about another
     * Displayable item.
     */
