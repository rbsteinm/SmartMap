...
public class ModifyFilterActivity extends Activity {
        ...
        builder.setPositiveButton(this.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Toast.makeText(ModifyFilterActivity.this,
                    ModifyFilterActivity.this.getResources().getString(R.string.removed_filter), Toast.LENGTH_LONG)
                    .show();
    ...
    public void renameFilterDialog(MenuItem item) {
        ...
        builder.setPositiveButton(this.getResources().getString(R.string.action_rename_filter_button),
            new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Toast.makeText(ModifyFilterActivity.this,
                        ModifyFilterActivity.this.getResources().getString(R.string.new_name_saved), Toast.LENGTH_LONG)
                        .show();
        ...
        // Add negative button
        builder.setNegativeButton(ModifyFilterActivity.this.getResources().getString(R.string.action_cancel_button),
            new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int id) {
                    dialog.cancel();
