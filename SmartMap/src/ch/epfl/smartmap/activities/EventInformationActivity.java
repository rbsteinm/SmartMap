...
public class EventInformationActivity extends FragmentActivity {
     ...
     * @author SpicyCH
     */
    private void initializeGUI(String creatorName) {
        ...
        String startString = Utils.getDateString(mEvent.getStartDate()) + " "
                + Utils.getTimeString(mEvent.getStartDate());
    ...
    class LoadEventTask extends AsyncTask<Long, Void, Map<String, Object>> {
        ...
        protected void onPostExecute(Map<String, Object> result) {
            ...
            if ((event == null) || (creatorName == null)) {
                ...
                mEvent = event;
                EventInformationActivity.this.initializeGUI(creatorName);
            }
        }
    }
}