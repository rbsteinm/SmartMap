...
/**
 * This activity is created when the user successfully logged in to SmartMap
 * (using facebook, sms, or other methods).
 * 
 * @author SpicyCH
 */
public class LoggedInActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        this.getMenuInflater().inflate(R.menu.logged_in, menu);
        return true;
    }
