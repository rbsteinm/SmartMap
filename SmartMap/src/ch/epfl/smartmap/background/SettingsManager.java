...
public final class SettingsManager {
    ...
    /**
     * @return the maximum distance from the user, in km, for which we can fetch events.<br />
     *         Special cases: 0 if the user selected 'None' and 41000 if the user selected 'All'.
     * @author SpicyCH
     */
